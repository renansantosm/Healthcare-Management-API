...
<p align="center">
A Healthcare Management API é um backend voltado para clínicas, que permite cadastrar e administrar doutores, pacientes e consultas. Desenvolvida como projeto de portfólio, oferece um sistema organizado para registro de profissionais de saúde, manutenção de dados de pacientes e agendamento de atendimentos.
</p>
