...
{
    private readonly UpdatePrescriptionCommandValidator _validator;

    public UpdatePrescriptionCommandValidatorTests()
    {
        _validator = new UpdatePrescriptionCommandValidator();
    }
    ...
    [Fact]
    public void Should_Have_Error_When_PrescriptionId_Is_Empty()
    {
        // Arrange
        var command = new UpdatePrescriptionCommand(
            Guid.NewGuid(),
    ...
    [Fact]
    public void Should_Not_Have_Error_When_PrescriptionId_Is_NotEmpty()
    {
        // Arrange
        var command = new UpdatePrescriptionCommand(
            Guid.NewGuid(),
        ...
        // Assert
        result.ShouldNotHaveValidationErrorFor(x => x.PrescriptionId);
    }
